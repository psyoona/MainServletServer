	...
	public BufferedImage resize(String fileOne, String fileTwo, String fileThree, String emotion, String loginID) {
		try {
			...
			resizeImage2 = image2.getScaledInstance(background.getWidth() / 2 - background.getWidth() / 42,
					background.getHeight() / 2 - background.getHeight() / 20, Image.SCALE_SMOOTH);
			resizeImage3 = image3.getScaledInstance(background.getWidth() - background.getWidth() / 21 + 3,
					background.getHeight() / 2 - background.getHeight() / 20, Image.SCALE_SMOOTH);
			...
			newImage3 = new BufferedImage(background.getWidth() - background.getWidth() / 21 + 3,
					background.getHeight() / 2 - background.getHeight() / 20, BufferedImage.TYPE_INT_RGB);
